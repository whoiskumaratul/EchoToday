...
import entertainment from '../../../data/entertainment/entertainment.json';  
...
const EntertainmentCard = () => {
  ...
  const [filteredArticles, setFilteredArticles] = useState(entertainment);

  useEffect(() => {
    const filtered = entertainment.filter(article =>
