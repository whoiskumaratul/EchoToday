...
import lifestyle from '../../../data/lifestyle/lifestyle.json';  
...
const LifeStyleCard = () => {
  ...
  const [filteredArticles, setFilteredArticles] = useState(lifestyle);

  useEffect(() => {
    const filtered = lifestyle.filter(article =>
