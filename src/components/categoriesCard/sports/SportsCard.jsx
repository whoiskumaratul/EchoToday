...
import sports from '../../../data/sports/sports.json'; // Adjust the path as needed
...
const SportsCard = () => {
  ...
  const [filteredArticles, setFilteredArticles] = useState(sports);

  useEffect(() => {
    const filtered = sports.filter(article =>
